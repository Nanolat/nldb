...
%.o: ../%.cpp
	...
	g++ -I"/home/ladmin/tmp/nldb/src/../external-libs/include" -I"/home/ladmin/tmp/nldb/src/include" -I"/home/ladmin/tmp/nldb/src/txbase" -I"/home/ladmin/tmp/nldb/src/nldb" -O3 -Wall -c -fmessage-length=0 -std=c++0x -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
