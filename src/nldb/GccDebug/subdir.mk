...
%.o: ../%.cpp
	...
	g++ -D_GLIBCXX_USE_NANOSLEEP -DDEBUG -I../../include -I../../txbase -I../../disruptor-- -I../../../external-libs/include -O0 -g3 -Wall -c -fmessage-length=0 -std=c++0x  -static-libgcc -static-libstdc++ -nodefaultlibs -shared -fPIC -fPIC -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
